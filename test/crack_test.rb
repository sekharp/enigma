...
class CrackedTest < Minitest::Test
  ...
  def test_that_program_initializes_todays_date_and_input_string
    ...
    assert_equal 200915, cracked.date
  ...
  def test_that_crack_key_a_rotation_can_get_the_correct_offset_number_with_a_different_string_length
    cracked = Cracked.new("1w xqfb3,7krqfli.3bi14740370 ad2t.77xw,2xzqpww,l6w n,g w4k7n z,vqfet.wp4 7krrwtza ay,wqstf7mxw,2tlvjr3korx")

    assert_equal 19, cracked.crack_key_full_rotation(-4)
  end

  def test_that_crack_key_a_rotation_can_get_the_correct_offset_with_the_same_message_but_encrypted_with_a_different_key
  ...
  def test_that_crack_key_b_rotation_can_get_the_correct_offset_number_with_a_different_string_length
    cracked = Cracked.new("1w xqfb3,7krqfli.3bi14740370 ad2t.77xw,2xzqpww,l6w n,g w4k7n z,vqfet.wp4 7krrwtza ay,wqstf7mxw,2tlvjr3korx")

    assert_equal 25, cracked.crack_key_full_rotation(-3)
  end

  def test_that_crack_key_b_rotation_can_get_the_correct_offset_with_the_same_message_but_encrypted_with_a_different_key
    cracked = Cracked.new("9eo3y0s9hp1xy02oglso9ml 8ll6fvu81tla5eq85h7v4eqrbeoth1o2,5ltfhq1y0vzge6 fp1xze 5isr4he7y10ls5eq816,pzl1uzf")
  ...
  def test_that_crack_key_c_rotation_can_get_the_correct_offset_number_with_a_different_string_length
    cracked = Cracked.new("1w xqfb3,7krqfli.3bi14740370 ad2t.77xw,2xzqpww,l6w n,g w4k7n z,vqfet.wp4 7krrwtza ay,wqstf7mxw,2tlvjr3korx")

    assert_equal 36, cracked.crack_key_full_rotation(-2)
  end

  def test_that_crack_key_c_rotation_can_get_the_correct_offset_with_the_same_message_but_encrypted_with_a_different_key
    cracked = Cracked.new("9eo3y0s9hp1xy02oglso9ml 8ll6fvu81tla5eq85h7v4eqrbeoth1o2,5ltfhq1y0vzge6 fp1xze 5isr4he7y10ls5eq816,pzl1uzf")
  ...
  def test_that_crack_key_d_rotation_can_get_the_correct_offset_number_with_a_different_string_length
    cracked = Cracked.new("1w xqfb3,7krqfli.3bi14740370 ad2t.77xw,2xzqpww,l6w n,g w4k7n z,vqfet.wp4 7krrwtza ay,wqstf7mxw,2tlvjr3korx")

    assert_equal 11, cracked.crack_key_full_rotation(-1)
  end

  def test_that_crack_key_d_rotation_can_get_the_correct_offset_with_the_same_message_but_encrypted_with_a_different_key
    cracked = Cracked.new("9eo3y0s9hp1xy02oglso9ml 8ll6fvu81tla5eq85h7v4eqrbeoth1o2,5ltfhq1y0vzge6 fp1xze 5isr4he7y10ls5eq816,pzl1uzf")
